...
var (
	playerDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `CreatedAt`: `timestamp without time zone`, `LastPlayed`: `timestamp without time zone`, `TotalGames`: `integer`}
	_             = bytes.MinRead
)
