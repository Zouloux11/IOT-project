...
type Player struct {
	...
	LastPlayed null.Time `boil:"last_played" json:"last_played,omitempty" toml:"last_played" yaml:"last_played,omitempty"`
	TotalGames null.Int  `boil:"total_games" json:"total_games,omitempty" toml:"total_games" yaml:"total_games,omitempty"`
...
var PlayerTableColumns = struct {
	...
	LastPlayed: "players.last_played",
	TotalGames: "players.total_games",
}
...
var PlayerWhere = struct {
	...
	LastPlayed whereHelpernull_Time
	TotalGames whereHelpernull_Int
}{
	...
	LastPlayed: whereHelpernull_Time{field: "\"players\".\"last_played\""},
	TotalGames: whereHelpernull_Int{field: "\"players\".\"total_games\""},
}
...
var (
	playerAllColumns            = []string{"id", "name", "created_at", "last_played", "total_games"}
	playerColumnsWithoutDefault = []string{"name"}
	playerColumnsWithDefault    = []string{"id", "created_at", "last_played", "total_games"}
...
func (o PlayerSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"players\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, playerPrimaryKeyColumns, len(o))
